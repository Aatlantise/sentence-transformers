...
class ClusterEvaluation:
    ...
    def __init__(self, groundtruthlabels, predicted_clusters):
        ...
        self.gold_label_list = groundtruthlabels
        self.pred_list = predicted_clusters
    ...
    def v_measure(self):
        return v_measure_score(self.gold_label_list, self.pred_list)

    def adj_rand_score(self):
        return adjusted_rand_score(self.gold_label_list, self.pred_list)
    ...
    def printEvaluation(self):
        ...
        m = {'F1': F1B3, 'F0.5': F05B3, 'precision': precB3, 'recall': recB3, 'v_measure': v_measure, 'ARI': ari}
        return m
